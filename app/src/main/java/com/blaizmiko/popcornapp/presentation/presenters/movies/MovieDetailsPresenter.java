...
public class MovieDetailsPresenter extends BaseMvpPresenter<MovieDetailsView>{
    ...
    public void loadMovie(int id) {
        ...
        final Subscription detailMovieSubscription = mPealApi.getMovie(id, Constants.TheMovieDbApi.IncludeImageLanguage, Constants.TheMovieDbApi.MovieDetailsAppendToResponse)
